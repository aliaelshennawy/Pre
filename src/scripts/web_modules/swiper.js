...
var virtual = {
  ...
  create: function create() {
    var swiper = this;
    bindModuleMethods(swiper, {
      virtual: _extends$1(_extends$1({}, Virtual), {}, {
...
var a11y = {
  ...
  create: function create() {
    var swiper = this;
    bindModuleMethods(swiper, {
      a11y: _extends$a(_extends$a({}, A11y), {}, {
...
var autoplay = {
  ...
  create: function create() {
    var swiper = this;
    bindModuleMethods(swiper, {
      autoplay: _extends$d(_extends$d({}, Autoplay), {}, {
        running: false,
        paused: false
      })
    });
